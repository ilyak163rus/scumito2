...
public class ProductController {
    ...
    @PostMapping("/product/{id}/response")
    public String makeResponse(@ModelAttribute("response") Response response, Principal principal, Product product) {
        responseService.makeResponse(response, principal, product);
